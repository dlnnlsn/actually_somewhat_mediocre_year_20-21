...
Letting $x = 2$, we see that the constant is $2P(0)$. Thus the equation is simply
$$(x + 1)P(x - 1) - (x - 1)P(x) = 2P(0) $$
Leeting $x = 0$, we get $P(-1) = P(0)$. Consider now the polynomial $Q(x) = P(x) - P(0)$. Substituting $P(x) = Q(x) + P(0)$ into the equation, we get
\begin{align*}
...
$$P(x) = kx(x + 1) + c$$
so indeed all polynomials of the form $P(x) = kx(x + 1) + c$ satisfy the constaint.
