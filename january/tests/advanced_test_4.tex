...
Let $\triangle ABC$ be an acute-angled triangle with orthocentre $H$. The point $H'$ is symmetric with $H$ with respect to the line $AB$. Let $N$ be the intersection of $HH'$ and $AB$. The circle passing through the points $A$, $N$ and $H'$ intersects $AC$ again at $M$. The circle passing through the points $B$, $N$ and $H'$ intersects $BC$ again at $P$. Show that the points $M$, $N$ and $P$ are collinear.
