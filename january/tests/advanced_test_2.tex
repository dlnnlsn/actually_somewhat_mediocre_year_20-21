...
\item % Liam 
Let $S$ be the set of $9$ distinct integers all of whose prime factors are at most $3$. Prove that $S$ contains $3$ distinct integers such that their product is a perfect cube.
