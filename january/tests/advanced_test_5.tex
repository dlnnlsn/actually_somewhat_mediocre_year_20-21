...
Let $\triangle ABC$ have $ \angle B>\angle C$. The internal angle bisector of $A$ intersects $BC$ at $D$ and the external angle bisector of $A$ intersect $BC$ at $E$. $ P$ is a variable point on $ EA$ such that $ A$ is on $EP$. $ DP$ intersects $ AC$ at $ M$ and $ ME$ intersects $ AD$ at $ Q$. Prove that all lines $ PQ$ intersect at a unique point as $ P$ changes.
