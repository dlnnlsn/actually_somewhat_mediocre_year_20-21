...
Now note that $22 = 11 + 11$, so we can replace $22$ with $11 \times 11 = 121$. Then $121 = 100 + 21$, so we can replace $121$ with $100 \times 21 = 2100$. This is larger than $2021$, so repeatedly replace the current number that we have with its predecessor until we obtain $2021$.
